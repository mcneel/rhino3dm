...
from typing import Any, Iterable, Iterator,List, overload, Tuple, Union
...
class DracoCompression:
    ...
    @staticmethod
    def DecompressByteArray(buffer: bytes) -> GeometryBase: ...
    @staticmethod
...
class DracoCompressionOptions:
    ...
    TextureCoordintateQuantizationBits: int
...
class File3dm:
    ...
    @property
    def Layers(self) -> File3dmLayerTable: ...
    @property
...
class File3dmLayerTable:
    ...
    def Add(self, new_layer: Layer) -> int: ...

    def AddLayer(self, name: str, color: tuple[int, int, int, int]) -> int: ...

    def Delete(self, layer_id: UUID) -> bool: ...

    def FindId(self, layer_id: UUID) -> Union[Layer, None]: ...

    def FindIndex(self, index: int) -> Layer: ...

    def FindName(self, name: str, parentId: UUID) -> Union[Layer, None]: ...
...
class MeshVertexList:
    ...
    def SetPoint3dAt(self, index: int, point: Point3d) -> bool: ...
    def ToPoint3dArray(self) -> Tuple[Point3d, ...]: ...
    def ToPoint3fArray(self) -> Tuple[Point3f, ...]: ...
    def Clear(self) -> None: ...
    def Destroy(self) -> None: ...
    def Add(self, x: float, y: float, z: float) -> int: ...
    def AddPoint3d(self, x: float, y: float, z: float) -> int: ...
...
class Point3d:
    ...
    def Transform(self, xform: Transform) -> Point3d: ...
...
class Vector3d:
    ...
    @property
    def Z(self) -> float: ...
    def Transform(self, xform: Transform) -> Vector3d: ...
...
class Polyline(Point3dList):
    ...
    @overload
    @staticmethod
    def CreateFromPoints(points: Point3dList) -> Polyline: ...
    @overload
    @staticmethod
    def CreateFromPoints(points: Iterable[Point3d]) -> Polyline: ...
    @staticmethod
