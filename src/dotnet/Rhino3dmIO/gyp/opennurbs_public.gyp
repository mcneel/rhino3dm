{
    "conditions": [
        ["OS=='win'", {
            ...
            "target_defaults": {
                ...
                "configurations": {
                    "Debug": {
                        "defines": ["DEBUG", "OPENNURBS_PUBLIC"],
                        "xcode_settings": {
                    ...
                    "Release": {
                        "defines": ["NDEBUG", "OPENNURBS_PUBLIC"],
                        "xcode_settings": {
    ...
    "targets": [
        {
            "target_name": "opennurbs_public_staticlib",
            "type": "static_library",
            "msvs_guid": "23288C65-E3EB-4D09-A648-22E1636EB40F",
            "msbuild_props": ["opennurbs_msbuild.Cpp.props"],
            "include_dirs": ["./freetype263/include"],
            ...
            "msvs_precompiled_header": "opennurbs.h",
            "msvs_precompiled_source": "opennurbs_precompiledheader.cpp",
