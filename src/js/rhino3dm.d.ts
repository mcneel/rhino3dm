declare module 'rhino3dm' {
	...
	class PointCloud extends GeometryBase {
		 ...
		 * @param {number[][]} points Points to insert.
		 * @returns {void}
		 */
		insertRange(index:number,points:number[][]): void;
		/**
	...
	class Polyline extends Point3dList {
		...
		constructor(initialCapacity: number);
		/**
		 * @description Test a polyline to see if it is closed.
		 * @param {number} tolerance The tolerance.
		 * @returns {boolean} Returns true if polyline has 4 or more points, the distance between the
