...
void initLayerBindings(pybind11::module& m)
{
  py::class_<BND_Layer, BND_CommonObject>(m, "Layer")
    ...
    .def("PerViewportColor", &BND_Layer::PerViewportColor)
    .def("SetPerViewportColor", &BND_Layer::SetPerViewportColor)
    .def("DeletePerViewportColor", &BND_Layer::DeletePerViewportColor)
