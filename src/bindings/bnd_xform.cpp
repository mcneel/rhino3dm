...
void initXformBindings(void*)
{
  ...
  class_<BND_Transform>("Transform")
    ...
    .class_function("translation", select_overload<BND_Transform(double, double, double)>(&BND_Transform::Translation))
    .class_function("translation", select_overload<BND_Transform(ON_3dVector)>(&BND_Transform::Translation1))
    .class_function("scale", &BND_Transform::Scale)
    .class_function("rotation", select_overload<BND_Transform(double, ON_3dVector, ON_3dPoint)>(&BND_Transform::Rotation))
    .class_function("rotation", select_overload<BND_Transform(ON_3dVector, ON_3dVector, ON_3dPoint)>(&BND_Transform::RotationFromTwoVectors)) 
    .class_function("mirror", select_overload<BND_Transform(ON_3dPoint, ON_3dVector)>(&BND_Transform::Mirror))
    .class_function("mirror", select_overload<BND_Transform(BND_Plane)>(&BND_Transform::Mirror2))
