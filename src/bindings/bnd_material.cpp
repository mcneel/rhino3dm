...
void initMaterialBindings(void*)
{
  class_<BND_PhysicallyBasedMaterial>("PhysicallyBasedMaterial")
    ...
    .function("getBaseColor",  &BND_PhysicallyBasedMaterial::GetBaseColor, allow_raw_pointers())
    .function("setBaseColor", &BND_PhysicallyBasedMaterial::SetBaseColor)
    .function("getEmissionColor",  &BND_PhysicallyBasedMaterial::GetEmissionColor, allow_raw_pointers())
    .function("setEmissionColor", &BND_PhysicallyBasedMaterial::SetEmissionColor)
    .function("getSubsurfaceScatteringColor",  &BND_PhysicallyBasedMaterial::GetSubsurfaceScatteringColor, allow_raw_pointers())
    .function("setSubsurfaceScatteringColor", &BND_PhysicallyBasedMaterial::SetSubsurfaceScatteringColor)
    ;
