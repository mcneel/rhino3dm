...
void initDimensionStyleBindings(pybind11::module& m)
{
  ...
  pyDimStyle.def(py::init<>())
    ...
    .def("IsFieldOverridden", &BND_DimensionStyle::IsFieldOverriden)
    .def("SetFieldOverride", &BND_DimensionStyle::SetFieldOverride)
    .def("ClearFieldOverride", &BND_DimensionStyle::ClearFieldOverride)
  ...
  py::enum_<ON_DimStyle::field>(pyDimStyle, "Field")
    ...
    .value("SuppressArrow1", ON_DimStyle::field::SuppressArrow2)
