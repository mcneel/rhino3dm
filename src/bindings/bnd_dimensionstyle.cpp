...
void initDimensionStyleBindings(rh3dmpymodule& m)
{
  ...
  pyDimStyle.def(py::init<>())
    ...
    .def_property("DimensionScale", &BND_DimensionStyle::GetDimScale, &BND_DimensionStyle::SetDimScale)
...
void initDimensionStyleBindings(void*)
{
  class_<BND_DimensionStyle, base<BND_CommonObject>>("DimensionStyle")
    ...
    .property("dimensionScale", &BND_DimensionStyle::GetDimScale, &BND_DimensionStyle::SetDimScale)
    ...
    .function("isFieldOverridden", &BND_DimensionStyle::IsFieldOverriden)
    .function("setFieldOverride", &BND_DimensionStyle::SetFieldOverride)
    .function("clearFieldOverride", &BND_DimensionStyle::ClearFieldOverride)
  ...
  enum_<ON_DimStyle::field>("DimensionStyleField")
    .value("Unset", ON_DimStyle::field::Unset)
    .value("Name", ON_DimStyle::field::Name)
    .value("Index", ON_DimStyle::field::Index)
    .value("ExtensionLineExtension", ON_DimStyle::field::ExtensionLineExtension)
