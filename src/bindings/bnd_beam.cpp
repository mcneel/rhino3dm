...
void initExtrusionBindings(rh3dmpymodule& m)
{
  py::class_<BND_Extrusion, BND_Surface>(m, "Extrusion")
    ...
    .def(py::init<>())
    .def("ToBrep", &BND_Extrusion::ToBrep, py::arg("splitKinkyFaces"))
    ...
    .def("GetProfileTransformation", &BND_Extrusion::GetProfileTransformation, py::arg("s"))
    .def("GetProfilePlane", &BND_Extrusion::GetProfilePlane, py::arg("s"))
    .def("GetPathPlane", &BND_Extrusion::GetPathPlane, py::arg("s"))
    .def("SetOuterProfile", &BND_Extrusion::SetOuterProfile, py::arg("outerProfile"), py::arg("cap"))
    .def("AddInnerProfile", &BND_Extrusion::AddInnerProfile, py::arg("innerProfile"))
    .def_property_readonly("ProfileCount", &BND_Extrusion::ProfileCount)
    .def("Profile3d", &BND_Extrusion::Profile3d, py::arg("profileIndex"), py::arg("s"))
    .def("Profile3d", &BND_Extrusion::Profile3d_2, py::arg("ci"))
    .def("WallEdge", &BND_Extrusion::WallEdge, py::arg("ci"))
    .def("WallSurface", &BND_Extrusion::WallSurface, py::arg("ci"))
...
void initExtrusionBindings(void*)
{
  class_<BND_Extrusion, base<BND_Surface>>("Extrusion")
    ...
    .function("wallEdge", &BND_Extrusion::WallEdge, allow_raw_pointers())
    .function("wallSurface", &BND_Extrusion::WallSurface, allow_raw_pointers())
    .function("pathLineCurve", &BND_Extrusion::PathLineCurve, allow_raw_pointers())
