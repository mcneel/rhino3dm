...
//    .function("groundPlane", &BND_RenderSettings::GetGroundPlane)
//    .function("safeFrame", &BND_RenderSettings::GetSafeFrame)
//    .function("dithering", &BND_RenderSettings::GetDithering)
//    .function("skylight", &BND_RenderSettings::GetSkylight)
//    .function("linearWorkflow", &BND_RenderSettings::GetLinearWorkflow)
//    .function("renderChannels", &BND_RenderSettings::GetRenderChannels)
//    .function("sun", &BND_RenderSettings::GetSun)
//    .function("renderEnvironments", &BND_RenderSettings::GetRenderEnvironments)
//    .function("postEffects", &BND_RenderSettings::GetPostEffects)
    ;
